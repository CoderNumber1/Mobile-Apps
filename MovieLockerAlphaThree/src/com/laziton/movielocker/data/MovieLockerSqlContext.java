...
public class MovieLockerSqlContext extends OrmLiteSqliteOpenHelper {
	...
	private static final int DATABASE_VERSION = DATABASE_V6;
	...
	public static final String MOVIE_IMAGE_URI = "ImageUri";
...
//														+ "foreign key(" + MOVIE_IMAGE_ID + ") references " + IMAGE_TABLE_NAME + "(" + IMAGE_ID + "), "
	...
	public void onCreate(SQLiteDatabase database, ConnectionSource connectionSource) {
		...
		database.execSQL("insert into " + GENRE_TABLE_NAME + "(" + GENRE_NAME + ") values('Action'),('Adventure'),('Animation'),('Comedy'),('Crime'),('Erotica'),('Faction'),('Fantasy'),('Historical'),('Horror'),('Live-Action Scripted'),('Live-Action Un-Scripted'),('Mystery'),('Paranoid'),('Philosophical'),('Political'),('Romance'),('Saga'),('Satire'),('Science Fiction'),('Slice of Life'),('Speculative'),('Thriller'),('Urban')");
	}
